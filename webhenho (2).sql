...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 02, 2025 lúc 04:34 PM
...
(10, 50, 'VIP', 'Active', '2025-12-02', '2025-11-02 21:46:41');
...
(27, 49, 'heo', '2004-02-02', 'Nữ', 'Độc thân', 39, 100, 'Kết hôn', 'Đại học', 'Hà Nội', 'Sưu tầm, Nghiên cứu khoa học, Chơi cờ', 'fff', 'public/uploads/avatars/avatar_49_1762080818.jpg'),
(28, 50, 'Quân', '2004-11-18', 'Nam', 'Độc thân', 30, 100, 'Hẹn hò', 'Thạc sĩ', 'Hà Nội', 'Sưu tầm, Nghiên cứu khoa học, Chơi cờ', 'hahaha', 'public/uploads/avatars/avatar_50_1762094751.jpg');
...
(47, 'admin', '0192023a7bbd73250516f069df18b500', 'active', '2025-11-02 20:33:36', 'admin'),
(48, 'example@gmail.com', '7d080f6a8d770a68fb28cadd3e7fe8f9', 'active', '2025-11-02 22:27:51', 'user'),
(49, 'example1@gmail.com', '7d080f6a8d770a68fb28cadd3e7fe8f9', 'active', '2025-11-02 22:27:51', 'user'),
(50, '0911186455', '7d080f6a8d770a68fb28cadd3e7fe8f9', 'active', '2025-11-02 22:27:52', 'user');
...
(8, 50, 99000.00, '2025-11-02 21:46:41');
...
--
ALTER TABLE `ghepdoi`
  MODIFY `maGhepDoi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT cho bảng `goidangky`
--
ALTER TABLE `goidangky`
  MODIFY `maGoiDangKy` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `thich`
  MODIFY `maThich` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
...
--
ALTER TABLE `timkiemghepdoi`
  MODIFY `maTimKiem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;

--
-- AUTO_INCREMENT cho bảng `tinnhan`
--
ALTER TABLE `tinnhan`
  MODIFY `maTinNhan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
