...
<body>
    ...
    <header class="main-header">
        <div class="header-container">
            ...
            <div class="nav-right">
                <a href="../dangnhap/login.php" class="btn-logout">
                    <i class="fas fa-sign-in-alt"></i>
                    Đăng Nhập
                </a>
                <a href="../dangky/register.php" class="btn-logout" style="margin-left: 10px; background: #28a745;">
    ...
    <script>
        ...
        function viewProfile(userId) {
            ...
            window.location.href = '../dangnhap/login.php?redirect=profile&id=' + userId;
        }
        ...
        function likeProfile(userId) {
            ...
            notification.innerHTML = `
                ...
                ">
                    ...
                    <button onclick="window.location.href='../dangnhap/login.php'" style="
                        padding: 10px 30px;
                        background: #FF6B9D;
                        color: white;
                        border: none;
